//
//  TTTrendsTwitterObjectsTweets651742188242665472EntitiesMediaEleModel.h
//  YBModelFileDemo
//
...
#import "TTTrendsTwitterObjectsTweets651742188242665472EntitiesMediaEleSizesModel.h"
#import "TTTrendsTwitterObjectsTweets651742188242665472EntitiesMediaEleFeaturesModel.h"

NS_ASSUME_NONNULL_BEGIN

@interface TTTrendsTwitterObjectsTweets651742188242665472EntitiesMediaEleModel : NSObject <NSCopying, NSCoding>
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651742188242665472EntitiesMediaEleSizesModel *sizes;

@property (nonatomic, copy) NSString *source_user_id_str;

@property (nonatomic, copy) NSString *expanded_url;

@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651742188242665472EntitiesMediaEleFeaturesModel *features;
