//
//  TTTrendsTwitterObjectsTweets652359500385550336CardBindingValuesModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets652359500385550336CardBindingValuesModel
...
- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets652359500385550336CardBindingValuesModel allocWithZone:zone] init];
    one.site = self.site;
