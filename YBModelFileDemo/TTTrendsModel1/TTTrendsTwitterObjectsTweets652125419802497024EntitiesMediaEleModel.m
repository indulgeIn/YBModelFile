//
//  TTTrendsTwitterObjectsTweets652125419802497024EntitiesMediaEleModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets652125419802497024EntitiesMediaEleModel

- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets652125419802497024EntitiesMediaEleModel allocWithZone:zone] init];
    one.id = self.id;
