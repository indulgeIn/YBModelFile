//
//  TTTrendsTwitterObjectsTweets651477635634208768EntitiesMediaEleModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets651477635634208768EntitiesMediaEleModel

- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets651477635634208768EntitiesMediaEleModel allocWithZone:zone] init];
    one.id = self.id;
