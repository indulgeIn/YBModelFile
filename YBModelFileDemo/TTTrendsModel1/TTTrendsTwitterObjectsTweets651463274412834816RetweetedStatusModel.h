//
//  TTTrendsTwitterObjectsTweets651463274412834816RetweetedStatusModel.h
//  YBModelFileDemo
//
...
#import "TTTrendsTwitterObjectsTweets651463274412834816RetweetedStatusUserModel.h"
#import "TTTrendsTwitterObjectsTweets651463274412834816RetweetedStatusExtendedEntitiesModel.h"

NS_ASSUME_NONNULL_BEGIN

@interface TTTrendsTwitterObjectsTweets651463274412834816RetweetedStatusModel : NSObject <NSCopying, NSCoding>

@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651463274412834816RetweetedStatusPlaceModel *place;
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651463274412834816RetweetedStatusEntitiesModel *entities;
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651463274412834816RetweetedStatusUserModel *user;

@property (nonatomic, copy) NSString *in_reply_to_user_id;

@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651463274412834816RetweetedStatusExtendedEntitiesModel *extended_entities;
