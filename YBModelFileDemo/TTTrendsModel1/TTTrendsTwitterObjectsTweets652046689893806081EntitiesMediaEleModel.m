//
//  TTTrendsTwitterObjectsTweets652046689893806081EntitiesMediaEleModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets652046689893806081EntitiesMediaEleModel

- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets652046689893806081EntitiesMediaEleModel allocWithZone:zone] init];
    one.id = self.id;
