//
//  TTTrendsTwitterObjectsTweets651463274412834816RetweetedStatusModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets651463274412834816RetweetedStatusModel

- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets651463274412834816RetweetedStatusModel allocWithZone:zone] init];
    ...
    one.extended_entities = self.extended_entities;
