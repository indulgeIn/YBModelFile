//
//  TTTrendsTwitterObjectsTweets651463274412834816EntitiesMediaEleModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets651463274412834816EntitiesMediaEleModel

- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets651463274412834816EntitiesMediaEleModel allocWithZone:zone] init];
    one.id = self.id;
