//
//  TTTrendsTwitterObjectsTweets651876577257635840ExtendedEntitiesMediaEleModel.h
//  YBModelFileDemo
//
...
@interface TTTrendsTwitterObjectsTweets651876577257635840ExtendedEntitiesMediaEleModel : NSObject <NSCopying, NSCoding>
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651876577257635840ExtendedEntitiesMediaEleSizesModel *sizes;

@property (nonatomic, copy) NSString *source_user_id_str;

@property (nonatomic, copy) NSString *expanded_url;

@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651876577257635840ExtendedEntitiesMediaEleFeaturesModel *features;
