//
//  TTTrendsTwitterObjectsTweets651876181776703488EntitiesMediaEleModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets651876181776703488EntitiesMediaEleModel

- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets651876181776703488EntitiesMediaEleModel allocWithZone:zone] init];
    one.id = self.id;
