//
//  TTTrendsTwitterObjectsTweets651676181666889728EntitiesMediaEleModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets651676181666889728EntitiesMediaEleModel

- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets651676181666889728EntitiesMediaEleModel allocWithZone:zone] init];
    one.id = self.id;
