//
//  TTTrendsTwitterObjectsTweets651876577257635840EntitiesMediaEleModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets651876577257635840EntitiesMediaEleModel

- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets651876577257635840EntitiesMediaEleModel allocWithZone:zone] init];
    one.id = self.id;
