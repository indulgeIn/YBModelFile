//
//  TTTrendsTwitterObjectsTweets652046689893806081ExtendedEntitiesMediaEleModel.h
//  YBModelFileDemo
//
...
#import "TTTrendsTwitterObjectsTweets652046689893806081ExtendedEntitiesMediaEleSizesModel.h"
#import "TTTrendsTwitterObjectsTweets652046689893806081ExtendedEntitiesMediaEleFeaturesModel.h"

NS_ASSUME_NONNULL_BEGIN

@interface TTTrendsTwitterObjectsTweets652046689893806081ExtendedEntitiesMediaEleModel : NSObject <NSCopying, NSCoding>
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets652046689893806081ExtendedEntitiesMediaEleSizesModel *sizes;

@property (nonatomic, copy) NSString *source_user_id_str;

@property (nonatomic, copy) NSString *expanded_url;

@property (nonatomic, strong) TTTrendsTwitterObjectsTweets652046689893806081ExtendedEntitiesMediaEleFeaturesModel *features;
