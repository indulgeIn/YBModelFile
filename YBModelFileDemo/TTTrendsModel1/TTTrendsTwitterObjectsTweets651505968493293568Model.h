//
//  TTTrendsTwitterObjectsTweets651505968493293568Model.h
//  YBModelFileDemo
//
...
#import "TTTrendsTwitterObjectsTweets651505968493293568RetweetedStatusModel.h"
#import "TTTrendsTwitterObjectsTweets651505968493293568UserModel.h"

NS_ASSUME_NONNULL_BEGIN

@interface TTTrendsTwitterObjectsTweets651505968493293568Model : NSObject <NSCopying, NSCoding>
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651505968493293568EntitiesModel *entities;

@property (nonatomic, copy) NSString *in_reply_to_screen_name;

@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651505968493293568RetweetedStatusModel *retweeted_status;
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651505968493293568UserModel *user;
