//
//  TTTrendsTwitterObjectsTweets651427487273119744CardBindingValuesModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets651427487273119744CardBindingValuesModel
...
- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets651427487273119744CardBindingValuesModel allocWithZone:zone] init];
    one.site = self.site;
