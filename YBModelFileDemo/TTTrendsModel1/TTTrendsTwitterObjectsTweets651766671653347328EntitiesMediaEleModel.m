//
//  TTTrendsTwitterObjectsTweets651766671653347328EntitiesMediaEleModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets651766671653347328EntitiesMediaEleModel

- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets651766671653347328EntitiesMediaEleModel allocWithZone:zone] init];
    one.id = self.id;
