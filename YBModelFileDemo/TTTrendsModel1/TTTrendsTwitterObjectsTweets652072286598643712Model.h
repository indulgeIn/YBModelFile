//
//  TTTrendsTwitterObjectsTweets652072286598643712Model.h
//  YBModelFileDemo
//
...
@interface TTTrendsTwitterObjectsTweets652072286598643712Model : NSObject <NSCopying, NSCoding>
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets652072286598643712CardModel *card;

@property (nonatomic, assign) BOOL is_quote_status;

@property (nonatomic, strong) TTTrendsTwitterObjectsTweets652072286598643712EntitiesModel *entities;
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets652072286598643712UserModel *user;
