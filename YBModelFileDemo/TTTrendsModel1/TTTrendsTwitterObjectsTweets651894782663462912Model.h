//
//  TTTrendsTwitterObjectsTweets651894782663462912Model.h
//  YBModelFileDemo
//
...
#import "TTTrendsTwitterObjectsTweets651894782663462912ExtendedEntitiesModel.h"

NS_ASSUME_NONNULL_BEGIN

@interface TTTrendsTwitterObjectsTweets651894782663462912Model : NSObject <NSCopying, NSCoding>
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651894782663462912EntitiesModel *entities;
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651894782663462912UserModel *user;

@property (nonatomic, copy) NSString *in_reply_to_user_id;

@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651894782663462912ExtendedEntitiesModel *extended_entities;
