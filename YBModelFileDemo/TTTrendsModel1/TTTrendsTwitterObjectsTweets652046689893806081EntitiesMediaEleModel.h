//
//  TTTrendsTwitterObjectsTweets652046689893806081EntitiesMediaEleModel.h
//  YBModelFileDemo
//
...
#import "TTTrendsTwitterObjectsTweets652046689893806081EntitiesMediaEleFeaturesModel.h"

NS_ASSUME_NONNULL_BEGIN

@interface TTTrendsTwitterObjectsTweets652046689893806081EntitiesMediaEleModel : NSObject <NSCopying, NSCoding>
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets652046689893806081EntitiesMediaEleSizesModel *sizes;

@property (nonatomic, copy) NSString *source_user_id_str;

@property (nonatomic, copy) NSString *expanded_url;

@property (nonatomic, strong) TTTrendsTwitterObjectsTweets652046689893806081EntitiesMediaEleFeaturesModel *features;
