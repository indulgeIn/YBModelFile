//
//  TTTrendsTwitterObjectsTweets651519482658078720CardBindingValuesModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets651519482658078720CardBindingValuesModel
...
- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets651519482658078720CardBindingValuesModel allocWithZone:zone] init];
    one.site = self.site;
