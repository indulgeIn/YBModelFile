//
//  TTTrendsTwitterObjectsTweets651477635634208768ExtendedEntitiesMediaEleModel.h
//  YBModelFileDemo
//
...
#import "TTTrendsTwitterObjectsTweets651477635634208768ExtendedEntitiesMediaEleSizesModel.h"
#import "TTTrendsTwitterObjectsTweets651477635634208768ExtendedEntitiesMediaEleFeaturesModel.h"

NS_ASSUME_NONNULL_BEGIN

@interface TTTrendsTwitterObjectsTweets651477635634208768ExtendedEntitiesMediaEleModel : NSObject <NSCopying, NSCoding>
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651477635634208768ExtendedEntitiesMediaEleSizesModel *sizes;

@property (nonatomic, copy) NSString *source_user_id_str;

@property (nonatomic, copy) NSString *expanded_url;

@property (nonatomic, strong) TTTrendsTwitterObjectsTweets651477635634208768ExtendedEntitiesMediaEleFeaturesModel *features;
