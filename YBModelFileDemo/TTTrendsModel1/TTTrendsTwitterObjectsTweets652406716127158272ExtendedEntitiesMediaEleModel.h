//
//  TTTrendsTwitterObjectsTweets652406716127158272ExtendedEntitiesMediaEleModel.h
//  YBModelFileDemo
//
...
#import "TTTrendsTwitterObjectsTweets652406716127158272ExtendedEntitiesMediaEleSizesModel.h"
#import "TTTrendsTwitterObjectsTweets652406716127158272ExtendedEntitiesMediaEleFeaturesModel.h"

NS_ASSUME_NONNULL_BEGIN

@interface TTTrendsTwitterObjectsTweets652406716127158272ExtendedEntitiesMediaEleModel : NSObject <NSCopying, NSCoding>
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets652406716127158272ExtendedEntitiesMediaEleSizesModel *sizes;

@property (nonatomic, copy) NSString *source_user_id_str;

@property (nonatomic, copy) NSString *expanded_url;

@property (nonatomic, strong) TTTrendsTwitterObjectsTweets652406716127158272ExtendedEntitiesMediaEleFeaturesModel *features;
