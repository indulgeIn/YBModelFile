//
//  TTTrendsTwitterObjectsTweets652355134454808577Model.h
//  YBModelFileDemo
//
...
#import "TTTrendsTwitterObjectsTweets652355134454808577CardModel.h"
...
@interface TTTrendsTwitterObjectsTweets652355134454808577Model : NSObject <NSCopying, NSCoding>
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets652355134454808577CardModel *card;

@property (nonatomic, assign) BOOL is_quote_status;

@property (nonatomic, strong) TTTrendsTwitterObjectsTweets652355134454808577EntitiesModel *entities;
...
@property (nonatomic, strong) TTTrendsTwitterObjectsTweets652355134454808577UserModel *user;
