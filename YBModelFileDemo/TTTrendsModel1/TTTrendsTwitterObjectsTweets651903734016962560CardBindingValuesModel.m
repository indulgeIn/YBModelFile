//
//  TTTrendsTwitterObjectsTweets651903734016962560CardBindingValuesModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets651903734016962560CardBindingValuesModel
...
- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets651903734016962560CardBindingValuesModel allocWithZone:zone] init];
    one.site = self.site;
