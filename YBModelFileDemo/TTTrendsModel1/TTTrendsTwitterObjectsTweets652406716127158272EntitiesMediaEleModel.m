//
//  TTTrendsTwitterObjectsTweets652406716127158272EntitiesMediaEleModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets652406716127158272EntitiesMediaEleModel

- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets652406716127158272EntitiesMediaEleModel allocWithZone:zone] init];
    one.id = self.id;
