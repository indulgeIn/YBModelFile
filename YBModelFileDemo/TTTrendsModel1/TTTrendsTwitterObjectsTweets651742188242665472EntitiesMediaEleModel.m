//
//  TTTrendsTwitterObjectsTweets651742188242665472EntitiesMediaEleModel.m
//  YBModelFileDemo
//
...
@implementation TTTrendsTwitterObjectsTweets651742188242665472EntitiesMediaEleModel

- (id)copyWithZone:(NSZone *)zone {
    typeof(self) one = [[TTTrendsTwitterObjectsTweets651742188242665472EntitiesMediaEleModel allocWithZone:zone] init];
    one.id = self.id;
